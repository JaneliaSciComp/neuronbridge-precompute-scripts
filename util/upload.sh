...
DATA_DIR=/nrs/neuronbridge/v2
UPLOAD_BUCKET=s3://janelia-neuronbridge-data-int
VERSION_FOLDER=v2_1_1
...
# CDS results
# $EXEC_CMD aws s3 cp \
#     ${DATA_DIR}/${VERSION_FOLDER}/${STEP_SUBDIR}/flylight-vs-flyem \
#     ${UPLOAD_BUCKET}/${VERSION_FOLDER}/metadata/cdsresults --recursive
# $EXEC_CMD aws s3 cp \
#     ${DATA_DIR}/${VERSION_FOLDER}/${STEP_SUBDIR}/flyem-vs-flylight \
#     ${UPLOAD_BUCKET}/${VERSION_FOLDER}/metadata/cdsresults --recursive

# metadata files
$EXEC_CMD aws s3 cp \
    ${DATA_DIR}/${VERSION_FOLDER}/DATA_VERSION \
    ${UPLOAD_BUCKET}/${VERSION_FOLDER}/DATA_VERSION
$EXEC_CMD aws s3 cp \
    ${DATA_DIR}/${VERSION_FOLDER}/DATA_NOTES.md \
    ${UPLOAD_BUCKET}/${VERSION_FOLDER}/DATA_NOTES.md
$EXEC_CMD aws s3 cp \
    ${DATA_DIR}/${VERSION_FOLDER}/publishedNames.txt \
    ${UPLOAD_BUCKET}/${VERSION_FOLDER}/publishedNames.txt

# do last; updating this file switchs to new results
# $EXEC_CMD aws s3 cp \
#     ${DATA_DIR}/${VERSION_FOLDER}/paths.json \
